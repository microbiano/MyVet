...
namespace MyVet.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var owner = await _dataContext.Owners
                .Include(o => o.User)
                .FirstOrDefaultAsync(o => o.OwnerId == id.Value);
            if (owner == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(EditUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                var owner = await _dataContext.Owners
                    .Include(o => o.User)
                    .FirstOrDefaultAsync(o => o.OwnerId == model.Id);
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty,"the owner can´t delete becasuse relared with pets");
                return RedirectToAction(nameof(Index));
            }
        ...
        {
            return _dataContext.Owners.Any(e => e.OwnerId == id);
        }
        ...
        public async Task<IActionResult> AddPet(PetViewModel model)
        {
            ...
            model.PetTypes = _combosHelper.GetCombosPetTypes();
        ...
        public async Task<IActionResult> DetailsPet(int? id)
        {
            ...
            var pet = await _dataContext.Pets
                ...
                .FirstOrDefaultAsync(o => o.PetId == id.Value);
            if (pet == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> EditHistory(int? id)
        {
            ...
            var history = await _dataContext.Histories
                ...
                .FirstOrDefaultAsync(p => p.HistoryId == id.Value);
            if (history == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteHistory(int? id)
        {
            ...
            var history = await _dataContext.Histories
                .Include(h => h.Pet)
                .FirstOrDefaultAsync(h => h.HistoryId == id.Value);
            if (history == null)
            {
                return NotFound();
            }
            ...
            await _dataContext.SaveChangesAsync();
            return RedirectToAction($"{nameof(DetailsPet)}/{history.Pet.PetId}");
        }
        ...
        public async Task<IActionResult> DeletePet(int? id)
        {
            ...
            var pet = await _dataContext.Pets
                .Include(p => p.Owner)
                .Include(p=>p.Histories)
                .FirstOrDefaultAsync(p => p.PetId == id.Value);
            ...
            if (pet.Histories.Count > 0)
            {
                ...
                return RedirectToAction($"{nameof(Details)}/{pet.Owner.OwnerId}");
            }
